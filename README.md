...
## 📚 서비스 소개
- AI를 기반으로 자신이 소유한 희귀동물의 이미지를 생성할 수 있고, 이를 NFT(Non-Fungible Token)로 발행할 수 있습니다.
- 발행된 희귀동물 NFT 목록을 검색/조회할 수 있고, 이를 이더리움을 통해 거래할 수 있습니다.
- 도감을 통해 각 희귀동물에 대한 상세한 정보를 얻을 수 있습니다. 
- 인증기관(DITI)에서 Metamask로 로그인할 수 있고, 블록체인 기반 DID(탈중앙화 신원증명)를 바탕으로 신원 인증서를 발급받을 수 있습니다.
- 인증기관(DITI)에서 발급된 인증서를 기반으로 간편 로그인이 가능합니다. 
<br>
