...
export function Section3() {
  return (
    <>
    <div className="flex flex-col w-[1440px] items-center pl-[430px] pr-[466px] py-0 relative bg-[#10b0b01a]">
      <div className="relative w-[1024px] h-[750px] ml-[-240.00px] mr-[-240.00px]">
        <div className="absolute w-[392px] h-[442px] top-[154px] left-0">
          ...
          <div className="inline-flex flex-col items-start pl-0 pr-[59px] py-0 absolute top-[34px] left-0">
            <div className="relative w-fit mt-[-1.00px] [font-family:'Segoe_UI-Bold',Helvetica] font-bold text-[#212529] text-[42px] tracking-[0] leading-[57px]">
              당신만 아는
              <br />
              동물 정보와 이야기
            </div>
          ...
          <div className="inline-flex flex-col items-start pl-0 pr-[99px] py-0 absolute top-[158px] -left-px">
            <p className="relative w-[275px] h-[90px] mt-[-1.00px] [font-family:'Segoe_UI-Regular',Helvetica] font-normal text-[#7c7c7c] text-[20px] tracking-[0] leading-[30px]">
              몰랐던 희귀동물의 다양한 정보와
              <br />
              NFT를 알아볼까요?
            </p>
          ...
          <div className="absolute w-[392px] h-[184px] top-[258px] left-0">
            <div className="left-0 flex flex-col w-[134px] items-start pl-0 pr-[10px] py-[16px] absolute top-0">
              <div className="relative w-[124px] h-[152px]">
                ...
                <div className="flex flex-col w-[124px] items-start pl-0 pr-[21px] py-0 absolute top-[101px] left-0">
