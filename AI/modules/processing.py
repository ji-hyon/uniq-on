...
class StableDiffusionProcessing:
    ...
    negative_prompt: str = "realistic, ultra high res, highres, dslr, photorealistic, 4k, 8k, uhd, lowes, nsfw, simple background, bad hands, text, error, missing fingers, strange fingers, extra digit, fewerdigits, cropped, worst quality, signature, watermark, username, blurry, bad anatomy, jpeg artifacts, ugly, pregnant, vore, duplicate, mutilated, missing legs, missing arms, extra arms, public hair, plump, bad legs, error legs, bad feet, mutation, transexual, bad proportions, nipples, glans, bare thights, naked, disfigured, bad art, deformed, extra limbs, long neck, cross-eye, moles, ng_deepnegative_v1_75t, (worst quality:1.4), (low quality:1.4), (normal quality:1.4), lowres, (nsfw:1.4), spider-man \(series\), "
    ...
    def setup_prompts(self, species : str):
        ...
        if species is not None:
            self.all_prompts[0]=species
            self.all_prompts[0]+=", Extreme toon \(style\),masterpiece, best quality, "
...
def process_images(p: StableDiffusionProcessing, species : str = None) -> Processed:
    ...
    try:
        ...
        res = process_images_inner(p, species)
    finally:
...
def process_images_inner(p: StableDiffusionProcessing, species : str = None) -> Processed:
